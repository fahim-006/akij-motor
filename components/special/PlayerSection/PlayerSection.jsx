  ...
  return (
    <div className="container mx-auto">
      <div className={classes.wrapper}>
        ...
        <p>
          <span className={classes.span}>A</span>KIJ MOTORS, one of the biggest auto mobile companies in Bangladesh.
          ...
          Benefit`. The mission is to <button className={classes.btn}>READ MORE</button>
        </p>
